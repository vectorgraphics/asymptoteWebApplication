...
export function Colon({className="", ...props}) {
  return (
...
export function DomainTarget({className="", ...props}) {
  return (
    <div className={className}>
      <div style={style}>
...
export function Mapsto({className="", ...props}) {
  return (
    <div className={className}>
      <div style={style}>
...
export function LetterA({className="", ...props}) {
  return (
    <div className={className}>
      <div style={style}>
...
export function LetterB({className="", ...props}) {
  return (
    <div className={className}>
      <div style={style}>
